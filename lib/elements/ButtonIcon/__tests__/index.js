...
describe('ButtonIcon Element', () => {
  ...
  it('adds the bgPrimary modifier', () => {
    const tree = renderWithTheme(
      <ButtonIcon modifiers={['bgPrimary']} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('adds the bgSecondary modifier', () => {
    const tree = renderWithTheme(
      <ButtonIcon modifiers={['bgSecondary']} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('adds the bgTertiary modifier', () => {
    const tree = renderWithTheme(
      <ButtonIcon modifiers={['bgTertiary']} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('adds the hoverBgPrimary modifier', () => {
    const tree = renderWithTheme(
      <ButtonIcon modifiers={['hoverBgPrimary']} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('adds the hoverBgSecondary modifier', () => {
    const tree = renderWithTheme(
      <ButtonIcon modifiers={['hoverBgSecondary']} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('adds the hoverBgTertiary modifier', () => {
    const tree = renderWithTheme(
      <ButtonIcon modifiers={['hoverBgTertiary']} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });
